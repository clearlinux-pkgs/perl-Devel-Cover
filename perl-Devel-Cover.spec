...
Source0  : https://cpan.metacpan.org/authors/id/P/PJ/PJCJ/Devel-Cover-1.45.tar.gz
...
%prep
%setup -q -n Devel-Cover-1.45
cd %{_builddir}/Devel-Cover-1.45
pushd ..
cp -a Devel-Cover-1.45 buildavx2
popd
