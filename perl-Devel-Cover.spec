...
Source0  : https://cpan.metacpan.org/authors/id/P/PJ/PJCJ/Devel-Cover-1.49.tar.gz
...
%prep
%setup -q -n Devel-Cover-1.49
cd %{_builddir}/Devel-Cover-1.49
pushd ..
cp -a Devel-Cover-1.49 buildavx2
popd
