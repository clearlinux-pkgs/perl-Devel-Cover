...
Source0  : https://cpan.metacpan.org/authors/id/P/PJ/PJCJ/Devel-Cover-1.50.tar.gz
...
%prep
%setup -q -n Devel-Cover-1.50
cd %{_builddir}/Devel-Cover-1.50
pushd ..
cp -a Devel-Cover-1.50 buildavx2
popd
...
cp %{_builddir}/Devel-Cover-%{version}/LICENCE %{buildroot}/usr/share/package-licenses/perl-Devel-Cover/eaa4d42042e7c9c54fdac91e640219ee22a4dfb6 || :
if test -f Makefile.PL; then
...
/usr/share/package-licenses/perl-Devel-Cover/eaa4d42042e7c9c54fdac91e640219ee22a4dfb6
